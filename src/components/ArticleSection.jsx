...
// Static articles content - SEO optimized
const staticArticles = [
  ...
  },
  {
    ...
    description:
      "Discover The Club Bali — one of the best places to eat near Kerobokan. Enjoy authentic French cuisine, fine wines, and a romantic dining experience. Located in the heart of Kerobokan, The Club Bali offers a unique blend of French sophistication and Balinese warmth.",
    image_url:
      "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800",
    category: "French Cuisine",
    published_at: new Date("2025-11-05").toISOString(), // November 5, 2025
    fullContent: `
    <article>
      <header>
        <h1>Best Places to Eat Near Kerobokan | The Club Bali</h1>
      </header>
      
      <p>Discover The Club Bali — one of the <strong>best places to eat near Kerobokan</strong>. Enjoy authentic French cuisine, fine wines, and a romantic dining experience. Located in the heart of Kerobokan, The Club Bali offers a unique blend of French sophistication and Balinese warmth.</p>

      <h2>Why The Club Bali Stands Out</h2>
      <p>When searching for the <strong>best places to eat near Kerobokan</strong>, The Club Bali consistently ranks at the top. The restaurant combines traditional French culinary techniques with fresh, locally sourced ingredients, creating dishes that are both elegant and flavorful.</p>
      <p>From classic French dishes like duck confit and escargots to innovative fusion creations, every meal at The Club Bali is a culinary journey. The elegant ambiance, attentive service, and curated wine selection make it a perfect choice for romantic dinners, special celebrations, or simply enjoying fine dining in Bali.</p>

      <h2>A Dining Experience Like No Other</h2>
      <p>The Club Bali's location in Kerobokan makes it easily accessible while offering a peaceful retreat from the bustling tourist areas. The restaurant's sophisticated interior, combined with tropical touches, creates an atmosphere that is both refined and welcoming.</p>
      <p>Whether you're a local resident or a traveler exploring Bali, The Club Bali offers an exceptional dining experience that showcases the best of French cuisine in a beautiful island setting.</p>

      <section>
        <h2>FAQs</h2>
        <dl>
          <dt><strong>What makes The Club Bali one of the best places to eat near Kerobokan?</strong></dt>
          <dd>The Club Bali combines authentic French cuisine, elegant ambiance, and exceptional service, making it a standout dining destination in the area.</dd>

          <dt><strong>Do I need to make a reservation?</strong></dt>
          <dd>Reservations are highly recommended, especially for weekends and special occasions, to ensure the best dining experience.</dd>

          <dt><strong>Is The Club Bali suitable for special occasions?</strong></dt>
          <dd>Absolutely. The restaurant's romantic setting and fine dining menu make it perfect for anniversaries, proposals, or any special celebration.</dd>
        </dl>
      </section>

      <footer>
        <h2>Conclusion</h2>
        <p>For those seeking the <strong>best places to eat near Kerobokan</strong>, The Club Bali offers an unforgettable dining experience that combines French culinary excellence with Balinese hospitality. Book your table today and discover why it's considered one of the top restaurants in the area.</p>
        <p><strong>🌐 Visit <a href="https://theclubbali.com" class="text-primary hover:underline">theclubbali.com</a> to explore the menu and reserve your table today.</strong></p>
      </footer>
    </article>
  `,
  ...
  },
  {
    ...
    image_url:
      "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800",
    category: "French Cuisine",
    published_at: new Date("2025-11-07").toISOString(), // November 7, 2025
    fullContent: `
    <article>
      <header>
  ...
  },
  {
    ...
    image_url:
      "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800",
    category: "Nightlife & Dining",
    published_at: new Date("2025-11-08").toISOString(), // November 8, 2025
    fullContent: `
    <article>
      <header>
