    ...
    <section id="exclusive-events" className="relative w-full bg-black">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20 lg:px-8 lg:py-24">
        ...
        >
          ...
          {/* Main title */}
          <h2 className="font-cormorant text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.06] tracking-[-0.02em]">
                ...
                <div className="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8">
                  <div className="grid gap-3 rounded-2xl border border-white/10 bg-black/35 p-5 md:p-6 backdrop-blur-xl">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
                      <div>
                        <p className="font-cormorant text-2xl md:text-3xl font-semibold text-white leading-tight">
                          {active.title}
                        </p>
